...
class BrowserManager:
    ...
    async def create_context(self) -> Tuple[str, BrowserContext]:
        ...
        context_args = {
            ...
            # Increase timeouts for slow Iranian internet
        ...
        context.set_default_navigation_timeout(utcms_config.DEFAULT_NAVIGATION_TIMEOUT)
        context.set_default_timeout(utcms_config.DEFAULT_ACTION_TIMEOUT)
        ...
        async with self._state_lock:
            try:
                ...
                logger.warning(
                    ...
                    extra={
                        "extra_fields": {"error": str(exc), "path": auth_state_path}
                    },
                )
...
class PageInteractor:
    ...
    async def safe_click(
        self, selector: str, wait_for_navigation: bool = False, timeout: int = 5000
    ):
