...
class TestEnhancedWaybillManager(unittest.IsolatedAsyncioTestCase):
    async def asyncSetUp(self):
        ...
        self.patcher_map_controller = patch('app.automation.waybill_enhanced.MapController')
        self.patcher_location_selector = patch('app.automation.waybill_enhanced.LocationSelector')
        self.patcher_route_calculator = patch('app.automation.waybill_enhanced.RouteCalculator')
